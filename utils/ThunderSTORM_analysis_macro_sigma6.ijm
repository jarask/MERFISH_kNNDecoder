...
// Load image stack
run("Bio-Formats Importer", "open=C:/Users/jakob/Documents/Repositories/MERFISH_decoding_analysis/data/"+points+"/a"+amplitude+"_p"+points_per_gene+"_bkg"+bkg+"/primary/primary-fov_000-c0-r0-z0.tiff color_mode=Default group_files rois_import=[ROI manager] view=Hyperstack stack_order=XYCZT dimensions axis_1_number_of_images=16 axis_1_axis_first_image=0 axis_1_axis_increment=1 contains=[] name=C:/Users/jakob/Documents/Repositories/MERFISH_decoding_analysis/data/"+points+"/a"+amplitude+"_p1_bkg"+bkg+"/primary/primary-fov_000-c0-r0-z0.tiff");
resetMinAndMax();
...
run("Export results", "filepath=C:\\Users\\jakob\\Documents\\Repositories\\MERFISH_decoding_analysis\\data\\"+points+"\\a"+amplitude+"_p"+points_per_gene+"_bkg"+bkg+"\\tsoutput.csv fileformat=[CSV (comma separated)] sigma=true intensity=true offset=true saveprotocol=false x=true y=true bkgstd=true id=true uncertainty=true frame=true");
